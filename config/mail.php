...
return [
  ...
  'mailers' => [
    'smtp' => [
        ...
        'from' => [
            'address' => env('MAIL_FROM_ADDRESS', 'default@domain.com'),
            'name' => env('MAIL_FROM_NAME', 'Project Inbox'),
        ],
    ],
    ...
    'smtp2' => [
        ...
        'from' => [
            'address' => env('MAIL2_FROM_ADDRESS', 'default2@domain.com'),
            'name' => env('MAIL2_FROM_NAME', 'Project Inbox'),
        ],
    ],
],
