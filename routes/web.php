...
Route::middleware(['custom_role:1,2,5'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('view.only')->group(function () {
        ...
        Route::get('/orders/{orderId}/split/{splitId}/export-smtp-csv', [AdminOrderController::class, 'exportSmtpSplitCsv'])->name('orders.split.export.smtp.csv');
        ...
        Route::get('/splits/{orderId}/orders', [AdminPanelController::class, 'getOrdersSplits'])->name('panels.orders.splits');
...
Route::middleware(['custom_role:4'])->prefix('contractor')->name('contractor.')->group(function () {
    ...
    Route::get('/assigned/order/data', [ContractorOrderController::class, 'getAssignedOrdersData'])->name('panels.assigned.orders.data');
