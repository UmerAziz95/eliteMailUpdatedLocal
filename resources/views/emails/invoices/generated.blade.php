        ...
        <div class="content">
            ...
            <div class="detail-card">
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $invoice->chargebee_invoice_id }}</span>
                </div>
                <div class="detail-row">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value highlight-text">{{ ucfirst($invoice->status) }}</span>
                </div>
                <div class="detail-row">
            ...
            <div style="text-align: center;">
                <a href="{{ route('customer.invoices.show', $invoice->id) }}" class="btn-primary">View Invoice Details</a>
            </div>
        </div>
