        ...
        <div class="content">
            ...
            <div class="detail-card">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value highlight-text">{{ ucfirst($ticket->priority) }}</span>
                </div>
                <div class="detail-row">
            ...
            <div class="detail-card">
                <h3 style="color: var(--second-primary); margin-bottom: 15px;">Description</h3>
            ...
            <div class="detail-card">
                <h3 style="color: var(--second-primary); margin-bottom: 15px;">Attachments</h3>
                <ul style="list-style: none; padding: 0;">
                    @foreach($ticket->attachments as $attachment)
                    <div class="detail-row">
                        <span class="detail-value">{{ basename($attachment) }}</span>
                    </div>
                    @endforeach
                </ul>
            </div>
            ...
            <!-- <div style="text-align: center;">
                <a href="{{ route('admin.support.tickets.show', $ticket->id) }}" class="btn-primary">View Ticket Details</a>
            </div> -->
        </div>
