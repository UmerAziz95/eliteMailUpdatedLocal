            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center p-5">
                        ...
                        <h2 class="mb-4 text-white">Pool Plan Subscription Successful! 🎉</h2>
                        <div style="background-color: #0bf04b2e; border: 1px solid #0bf04b;" class="mb-4 py-3 px-2 rounded-2">
                            <p class="mb-0 success ">Thank you for subscribing to our Pool Plan! Your account has been successfully upgraded.</p>
                        </div>
