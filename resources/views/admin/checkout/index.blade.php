                    ...
                    <div class="card card-custom p-4">
                        <div class="d-flex">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg"
                                alt="Google" class="me-3" style="width: 60px; height: 60px; object-fit: contain;">
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="input-group input-group-sm w-auto">
                                        ...
                                        <input type="number" style="max-width: 70px; border: 1px solid #ffffff36;"
                                            id="qty" class="px-2 bg-transparent rounded-0" value="1">
                                        <button class="btn btn-primary rounded-0" type="button"
                ...
                <div id="review-left" class="d-none">
                    ...
                    <div class="card card-custom p-3 mb-4">
                        ...
                        <p class="mb-0 small text-white">
                            ...
                            <input type="email" class="form-control d-none mt-1" id="inputEmail" value="qut.0112@hotmail.com">
                        </p>
                    </div>
                    ...
                    <div class="card card-custom p-3 mb-4">
                        ...
                        <p class="mb-1 small text-white">
                            ...
                            <input type="text" class="form-control d-none mt-1" id="inputBillingFirstName" value="5D Customer">
                        </p>
                        <p class="mb-1 small text-white">
                        ...
                        <p class="mb-0 small text-white">
                            ...
                            <input type="text" class="form-control d-none mt-1" id="inputBillingAddress" value="Address Line 1, City, ZIP">
                        </p>
                    </div>
                    ...
                    <div class="card card-custom p-3 mb-4">
                        ...
                        <p class="mb-1 small text-white">
                            ...
                            <input type="text" class="form-control d-none mt-1" id="inputShippingFirstName" value="5D Customer">
                        </p>
                        <p class="mb-1 small text-white">
                            <strong class="opacity-50 fw-light">Last Name:</strong>
                        ...
                        <p class="mb-0 small text-white">
                            ...
                            <input type="text" class="form-control d-none mt-1" id="inputShippingAddress" value="Same as billing">
                        </p>
                    </div>
                </div>
