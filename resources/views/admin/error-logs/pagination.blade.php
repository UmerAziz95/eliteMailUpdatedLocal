@if ($paginator->hasPages())
    <nav class="errorlogs-pagination" role="navigation" aria-label="Pagination Navigation">
        <div class="pagination-pill">
            <span class="text-white-50 small">Showing</span>
            ...
            <span class="text-white-50 small">of</span>
            <span class="fw-semibold text-white">{{ $paginator->total() }}</span>
            <span class="text-white-50 small">results</span>
        </div>
