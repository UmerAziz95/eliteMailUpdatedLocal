            ...
            <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="chargebee-tab" data-bs-toggle="tab"
                        data-bs-target="#chargebee_configuration_tab-pane" type="button" role="tab"
                        aria-controls="chargebee_configuration_tab-pane" aria-selected="false"><i
                            class="fa-solid fa-unlock"></i> Chargebee Configuration</button>
                </li>
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="configuration-pane" data-bs-toggle="tab"
                        data-bs-target="#system_configuration-pane" type="button" role="tab"
                        aria-controls="system_configuration-tab-pane" aria-selected="false"><i
                            class="fa-regular fa-file"></i> System Configuration</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="panel-config-tab" data-bs-toggle="tab"
                        data-bs-target="#panel_configuration-pane" type="button" role="tab"
                        aria-controls="panel_configuration-tab-pane" aria-selected="false"><i
                            class="fa-solid fa-sliders"></i> Panel Configurations</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pool-config-tab" data-bs-toggle="tab"
                        data-bs-target="#pool_configuration-pane" type="button" role="tab"
                        aria-controls="pool_configuration-tab-pane" aria-selected="false"><i class="fa-solid fa-water"></i>
                        Pool Configurations</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="smtp-provider-split-tab" data-bs-toggle="tab"
                        data-bs-target="#smtp_provider_split-pane" type="button" role="tab"
                        aria-controls="smtp_provider_split-tab-pane" aria-selected="false"><i
                            ...
                            <form id="chargebeeConfigForm">
                                ...
                                <div class="row gx-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" id="chargebeeSite" name="CHARGEBEE_SITE" class="form-control"
                                ...
                                <div class="row gx-3">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" id="chargebeeApiKey" name="CHARGEBEE_API_KEY"
                                            class="form-control" value="{{ $chargebeeArray['CHARGEBEE_API_KEY'] ?? '' }}"
                                ...
                                <div class="mt-4">
                                    ...
                                    <button type="submit" id="chargebeeConfigSubmit" class="btn btn-primary">Save
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 align-items-end mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="backupStart"
                                        value="{{ now()->subDays(30)->toDateString() }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label" for="backupEnd">End Date</label>
                                    <input type="date" class="form-control" id="backupEnd"
                                        value="{{ now()->toDateString() }}">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label" for="backupSizeMin">Min Size (MB)</label>
                                    <input type="number" min="0" step="1" class="form-control" id="backupSizeMin"
                                        placeholder="e.g. 10">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label" for="backupSizeMax">Max Size (MB)</label>
                                    <input type="number" min="0" step="1" class="form-control" id="backupSizeMax"
                                        placeholder="e.g. 500">
                                </div>
                                <div class="col-md-2 d-flex gap-2">
                                    <button type="button" id="applyBackupFilters"
                                        class="btn btn-primary w-100">Apply</button>
                                    <button type="button" id="resetBackupFilters"
                                        class="btn btn-secondary w-100">Reset</button>
                                </div>
                            </div>

                            <div class="table-responsive">
                                <table id="backupsTable" class="table table-bordered table-hover align-middle mb-0"
                                    style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Backup File</th>
                    ...
                    <div class="card mb-4 p-3">
                        ...
                        <div class="card-body">
                            <form id="systemConfigForm">
                                ...
                                <div class="row gx-4">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="systemName" name="SYSTEM_NAME"
                                            value="{{ $systemArray['SYSTEM_NAME'] ?? '' }}" placeholder="My Application">
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="adminEmail" class="form-label">Admin Email</label>
                                        <input type="email" class="form-control" id="adminEmail" name="ADMIN_EMAIL"
                                            value="{{ $systemArray['ADMIN_EMAIL'] ?? '' }}" placeholder="admin@example.com">
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div id="logoThumbnail"
                                                ...
                                                @if(!empty($systemArray['SYSTEM_LOGO']))
                                                    <img src="{{ asset($systemArray['SYSTEM_LOGO']) }}" id="logoThumbImg"
                                                        alt="Logo"
                                                        style="max-width: 100%; max-height: 100%; object-fit: contain;">
                                                @else
                                                    <i class="fa fa-image fa-2x text-muted" id="logoPlaceholderIcon"></i>
                                                    <img src="" id="logoThumbImg" alt="Logo"
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-danger ms-2"
                                                    id="removeLogo"
                                                    style="display: {{ !empty($systemArray['SYSTEM_LOGO']) ? 'inline-block' : 'none' }};">
                                ...
                                <div class="mt-3">
                                    <button type="submit" id="systemConfigSubmit" class="btn btn-primary">Save
                                        Configuration</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center text-muted">No panel configurations found.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center text-muted">No pool configurations found.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                    ...
                    <div class="row py-4">
                        <div class="col-12">
                            ...
                            <div class="alert alert-info glassy-alert" role="alert">
                                ...
                                <ol class="mb-0">
                                    <li>Set the split percentage for each provider (only active providers count toward 100%)
                                    </li>
                                    ...
                                    <li><strong>Important:</strong> Total percentage of active providers must equal 100%
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div id="providerSplitFormsContainer">
                                ...
                                @forelse ($providers as $provider)
                                    ...
                                    @endphp
                                    <div class="webhook-form provider-split-form" id="form-{{ $provider->slug }}"
                                        data-provider-id="{{ $provider->id }}" data-slug="{{ $provider->slug }}">
                                            ...
                                            <div class="status-toggle">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input status-switch" type="checkbox" role="switch"
                                                        id="status-{{ $provider->slug }}" data-slug="{{ $provider->slug }}" {{ ($provider->is_active ?? true) ? 'checked' : '' }}>
                                                </div>
                                                <span
                                                    class="status-indicator {{ ($provider->is_active ?? true) ? 'enabled' : 'disabled' }}"
                                        ...
                                        <form class="provider-settings-form" data-provider-id="{{ $provider->id }}"
                                            ...
                                            <div class="row g-3">
                                                ...
                                                @if(in_array($provider->slug, ['premiuminboxes', 'mailrun']))
                                                    {{-- PremiumInboxes/Mailrun: Show API Secret/Token Key only --}}
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="api_secret-{{ $provider->slug }}" class="form-label">
                                                                <i class="ti ti-key me-1"></i>
                                                                {{ $provider->slug === 'mailrun' ? 'API Token' : 'API Secret Key' }}
                                                                *
                                                            </label>
                                                            <div class="password-wrapper">
                                                                <input type="password" class="form-control"
                                                                    ...
                                                                    placeholder="Enter {{ $provider->slug === 'mailrun' ? 'API Token' : 'API Secret Key' }}"
                                                                    value="{{ $provider->password ?? '' }}" required>
                                                                <i class="fa-regular fa-eye password-toggle"></i>
                                                            </div>
                                                            <small class="form-text text-muted">
                                                                {{ $provider->slug === 'mailrun' ? 'API Token' : 'API Secret Key' }}
                                                                for {{ $provider->name }} authentication
                                                            </small>
                                                    ...
                                                    {{-- Hidden email and password fields for PremiumInboxes (not used but required
                                                    by validation) --}}
                                                    <input type="hidden" id="email-{{ $provider->slug }}"
                                                        name="providers[{{ $provider->id }}][email]" value="">
                                                ...
                                                @else
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="validation-error" id="password-error-{{ $provider->slug }}"
                                                                style="display: none;"></div>
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control split-percentage-input"
                                                            id="split_percentage-{{ $provider->slug }}"
                                                            name="providers[{{ $provider->id }}][split_percentage]"
                                                            value="{{ $provider->split_percentage ?? 0 }}" min="0" max="100"
                                                            step="0.01" required>
                                                        <small class="form-text text-muted">
                                                            Percentage of orders for this provider
                                                        </small>
                                                        <div class="validation-error"
                                                            id="percentage-error-{{ $provider->slug }}" style="display: none;">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control priority-input"
                                                            ...
                                                            value="{{ $provider->priority ?? 0 }}" min="0" required>
                                                        <small class="form-text text-muted">
                                                            Lower number = higher priority (must be unique)
                                                        </small>
                                                        <div class="validation-error" id="priority-error-{{ $provider->slug }}"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="mt-4">
                                <div class="alert alert-{{ abs($activeTotalPercentage - 100.00) > 0.01 ? 'warning' : 'success' }} glassy-alert"
                                    role="alert">
                                    <h6 class="alert-heading mb-1">
                                        <i
                                            class="ti ti-{{ abs($activeTotalPercentage - 100.00) > 0.01 ? 'alert-triangle' : 'check' }} me-2"></i>
                                        Active Providers Total Percentage
                                    </h6>
                                    <p class="mb-0">
                                        <strong>Total: <span
                                                id="activeTotalPercentage">{{ number_format($activeTotalPercentage, 2) }}</span>%</strong>
            ...
            <form id="editConfigForm">
                ...
                <div class="mb-3" id="booleanInput" style="display: none;">
                    ...
                    <div>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="configBoolValue" id="boolFalse"
                                value="false">
