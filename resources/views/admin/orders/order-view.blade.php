    ...
    <div class="d-flex align-items-center justify-content-between mt-3">
        <div>
            <div style="cursor: pointer; display: inline-flex; align-items: center; margin-bottom: 10px;">
                <a href="{{ url('/admin/orders') }}" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; background-color: #2f3349; border-radius: 50%; text-decoration: none;">
        ...
        <div class="border border-{{ $order->status_manage_by_admin == 'cancelled' ? 'warning' : ' success' }} rounded-2 py-1 px-2 text-{{ $order->status_manage_by_admin == 'reject' ? ' warning' : 'success' }} bg-transparent">
                ...
                <div class="col-md-6">
                    <div class="card p-3 mb-3">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span>{{ $order->reorderInfo->first()->prefix_variant_1 ?? 'N/A' }}, {{ $order->reorderInfo->first()->prefix_variant_2 ?? 'N/A' }}</span>
                    ...
                    <div class="card p-3">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                @else
                                <span>{{ $order->reorderInfo->first()->total_inboxes ?? '0' }} <b>X </b>  {{ number_format($order->amount,2) }} /monthly</span>
                                @endif
                            </div>
                        </div>
                    </div>
