<div class="card h-100 p-3 d-flex flex-column justify-content-between">
    <div class="border-0 pb-0 d-flex justify-content-between">
        <div class="card-title mb-0">
            <h6 class="mb-1" id="revenue_title">Revenue</h6>
        </div>
        <ul class="nav nav-pills d-flex align-items-center justify-content-end" id="revenue-pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link py-1 px-2 rounded-1 active" id="revenue-pills-month-tab" data-bs-toggle="pill"
                    data-bs-target="#revenue-pills-month" type="button" role="tab"
                    aria-controls="revenue-pills-month" aria-selected="true">Month</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link py-1 px-2 rounded-1" id="revenue-pills-week-tab" data-bs-toggle="pill"
                    data-bs-target="#revenue-pills-week" type="button" role="tab"
                    aria-controls="revenue-pills-week" aria-selected="false">Week</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link py-1 px-2 rounded-1" id="revenue-pills-day-tab" data-bs-toggle="pill"
                    data-bs-target="#revenue-pills-day" type="button" role="tab" aria-controls="revenue-pills-day"
    ...
    <div class="row align-items-center">
        ...
        <div class="col-12 mt-3">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <div>
                    <div class="d-flex gap-2 align-items-center flex-wrap">
                        <h5 class="mb-0 text-success" id="revenue_count_display">$0</h5>
                        <div class="badge rounded bg-label-success" id="revenue_growth_badge" style="display: none !important;">
                            +0%</div>
                    </div>
                ...
                <div class="revenue_totals">
                    {{-- <h6 class="theme-text opacity-100 mb-0">Total Revenue</h6> --}}
            ...
            <div class="tab-content" id="revenue-pills-tabContent">
                ...
                <!-- Week Tab -->
                <div class="tab-pane fade" id="revenue-pills-week" role="tabpanel"
                    aria-labelledby="revenue-pills-week-tab" tabindex="0">
                    <div id="revenue_week_chart"></div>
                </div>

                <!-- Day Tab -->
                <div class="tab-pane fade" id="revenue-pills-day" role="tabpanel"
                    aria-labelledby="revenue-pills-day-tab" tabindex="0">
...
<script>
    ...
    function updateRevenueStatistics(total, growth) {
        console.log(
            `Updating revenue statistics: total=${total}, growth=${growth}, currentPeriod=${revenue_current_period}`
            );
