                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                <div class="d-flex align-items-center text-nowrap">
                                    <div class="me-1 rounded-1 d-flex align-items-center justify-content-center" style="background-color: rgba(85, 255, 78, 0.4); height: 15px; width: 15px">
                                        <i style="color: #A6FF00" class="ti ti-file-description"></i>
                                    </div>
                                    <span>${data}</span>
                                </div>
                            `;
                    ...
                    setTimeout(function() {
                        Object.values(window.orderTables).forEach(function(table) {
                            if ($(table.table().node()).is(':visible')) {
                                ...
                                console.log('Adjusting columns for table:', table.table()
                                    .node().id);
                            }
                        });
                    }, 10);
