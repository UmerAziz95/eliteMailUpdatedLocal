    ...
    <div class="card-header border-0 pb-0 d-flex justify-content-between">
        ...
        <ul class="nav nav-pills mb-3 d-flex align-items-center justify-content-end" id="subscriptions-pills-tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="subscriptions-pills-month-tab" data-bs-toggle="pill"
                            data-bs-target="#subscriptions-pills-month" type="button" role="tab" aria-controls="subscriptions-pills-month"
                            aria-selected="true">Month</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="subscriptions-pills-week-tab" data-bs-toggle="pill" data-bs-target="#subscriptions-pills-week"
                            type="button" role="tab" aria-controls="subscriptions-pills-week" aria-selected="false">Week</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="subscriptions-pills-day-tab" data-bs-toggle="pill" data-bs-target="#subscriptions-pills-day"
                            type="button" role="tab" aria-controls="subscriptions-pills-day" aria-selected="false">Day</button>
                    </li>
                </ul>
    </div>
    <!--  -->
    <div class="card-body pt-0">
        <div class="row align-items-center g-md-8">
            <div class="col-12 col-md-5 d-flex flex-column">
                ...
                <div class="mt-4 subscriptions_totals">
                    <h6 class="text-light mb-3">Total Subscriptions</h6>
            ...
            <div class="col-12 col-md-7">
                ...
                <div class="tab-content" id="subscriptions-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="subscriptions-pills-week" role="tabpanel" aria-labelledby="subscriptions-pills-week-tab"
                        tabindex="0">
                        <div id="subscriptions_week_chart"></div>
                    </div>
                    <div class="tab-pane fade" id="subscriptions-pills-day" role="tabpanel" aria-labelledby="subscriptions-pills-day-tab"
                        tabindex="0">
...
<script>
    ...
    function updateSubscriptionsStatistics(total, growth) {
        console.log(`Updating statistics: total=${total}, growth=${growth}, currentPeriod=${subscriptions_current_period}`);
    ...
    function updateSubscriptionsChart(type, series, categories) {
        console.log(`Updating ${type} chart with:`, { series, categories });
