    ...
    <div class="offcanvas-body p-0">
        <div class="container-fluid h-100 d-flex flex-column">
            ...
            <div class="row py-3 px-4"
                style="background: var(--secondary-color); border-bottom: 1px solid var(--input-border);">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div style="width: 1px; height: 28px; background: var(--input-border); margin: 0 8px;">
                            </div>
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <div class="form-check form-switch" style="margin-bottom: 0;">
                                ...
                                <label class="form-check-label" for="autoRetryToggle"
                                    style="cursor: pointer; color: var(--light-color);">Auto Retry</label>
                            </div>
                            <div class="d-flex align-items-center gap-2">
                                <span style="color: var(--extra-light); font-size: 13px;">Attempts:</span>
                                <span id="retryCount" class="badge" style="background: var(--second-primary);">0 /
                                    3</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="fixTerminalOutput" class="h-100 p-3"
                        ...
                        <div class="terminal-welcome">
                            <div style="color: #00d4ff;">
                                ══════════════════════════════════════════════════════════════════════════</div>
                            <div style="color: #ffd700;"> 📧 Order Fixed Manually - Domain & Mailbox Service</div>
                            <div style="color: #00d4ff;">
                                ══════════════════════════════════════════════════════════════════════════</div>
            ...
            <div class="row py-3 px-3"
                style="background: var(--secondary-color); border-top: 1px solid var(--input-border);">
                <div class="col-12">
