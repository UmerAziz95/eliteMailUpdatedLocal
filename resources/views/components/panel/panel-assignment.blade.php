        ...
        <div class="batch-body">
            <div class="row g-3">
                ...
                <div class="col-lg-2 col-md-3 col-6">
                    ...
                    <input type="number" class="form-control domain-start" name="manual_assignments[][domain_start]"
                ...
                <div class="col-lg-2 col-md-3 col-6">
                    ...
                    <input type="number" class="form-control domain-end" name="manual_assignments[][domain_end]" min="1"
                        placeholder="100">
                </div>
        ...
        <script>
            ...
            window.manualPanelAssignment = (function ($) {
                ...
                function validateManualAssignments() {
                    // Skip validation if SMTP mode is enabled
