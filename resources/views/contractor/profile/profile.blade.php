...
<section class="py-4">
    ...
    <div class="row mt-4 justify-content-center">
        {{-- <div class="col-xl-4 col-lg-5 col-md-5">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled my-3 border rounded-2 pt-3 px-2">
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-user"></i><span
                                class="fw-semibold mx-2">First Name:</span> <span>{{ Auth::user()->name }}</span></li>
                        <li class="d-flex align-items-center mb-4">
                            <i class="ti ti-check"></i>
                            <span class="fw-semibold mx-2">Status:</span>
                            <span>{{ Auth::user()->status == '1' ? 'Active' : 'In-Active' }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-4">
        ...
        <div class="col-xl-6 col-lg-7 col-md-8">
            ...
            <div class="card mb-4 profile-card p-3">
                <div class="d-flex align-items-center justify-content-center gap-2">
                    ...
                    <ul class="mb-0">
                        <li class="d-flex align-items-center mb-4"><i class="ti ti-user"></i><span
                                class="fw-semibold mx-2">First Name:</span> <span class="opacity-50">{{
        ...
        {{-- <div class="col-xl-8 col-lg-7 col-md-7">
            <div class="card p-2 mb-4 overflow-y-auto" style="max-height: 37.7rem">
