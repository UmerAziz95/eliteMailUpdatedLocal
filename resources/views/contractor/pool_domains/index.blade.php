...
@section('content')
    <section class="py-3">
        ...
        <div class="tab-content" id="poolDomainsTabContent">
            <!-- My Pool Orders Tab -->
            <div class="tab-pane fade show active" id="pool-orders-tab-pane" role="tabpanel"
                aria-labelledby="pool-orders-tab" tabindex="0">
            ...
            <div class="tab-pane fade" id="all-domains-tab-pane" role="tabpanel" aria-labelledby="all-domains-tab"
                tabindex="0">
                <div class="card py-3 px-4 mb-4 shadow-sm border-0">
                    <div class="table-responsive">
        ...
        function lockOutOfInstantly(orderId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("contractor.pool-orders.lock-out-of-instantly") }}',
                        type: 'POST',
                        data: {
                            id: orderId,
                            _token: '{{ csrf_token() }}'
