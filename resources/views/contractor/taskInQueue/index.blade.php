...
<script>
    ...
    function createShiftedTaskCard(task) {
        ...
        card.innerHTML = `
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <div class="text-white-50 small mb-1">#${task.task_id || task.id} <span class="badge bg-info">Panel Shift</span></div>
                    <span class="badge px-2 py-1 rounded ${statusClass}">
                        ${task.status.charAt(0).toUpperCase() + task.status.slice(1).replace('-', ' ')}
                    </span>
                </div>
            ...
            <div class="mb-4">
                <div class="glass-box mb-2">
                    <div class="d-flex justify-content-between">
                        ...
                        <span class="fw-bold text-white">${task.action_type ? task.action_type.charAt(0).toUpperCase() + task.action_type.slice(1) : 'N/A'}</span>
                    </div>
                </div>
                <div class="glass-box mb-2">
                    <div class="d-flex justify-content-between">
